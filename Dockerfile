...
RUN apt-get -qq update && apt-get -qqy install g++ libpthread-stubs0-dev libicu-dev clang libc++-dev libc++abi-dev libboost-all-dev gdb valgrind git doxygen wget make checkinstall tar
